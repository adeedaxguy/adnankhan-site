...
Pricing: Most builds $4K–$12K fixed. Sprints $1.5K–$4.5K. Apps/AI $3K–$10K. Always escrow-protected via Upwork.
Process: Fixed price, fixed scope, fixed date. Async-first (Loom over meetings). Daily updates. 30 days post-launch support included.
...
If the visitor asks for pricing, give the typical range and suggest the contact form on the homepage.
...
export default async function handler(req) {
  ...
  function sanitizeReply(text) {
    ...
    if (firstClean > 0 && firstClean < paragraphs.length) {
      ...
      return "Pricing for most builds lands in the $4K–$12K range fixed-price, depending on scope. The fastest way to get a precise number is the contact form on the homepage — Adnan replies in four hours with three specific suggestions for your case.";
    }
  ...
  // Per-model timeout so a single stuck model can't burn the function budget.
