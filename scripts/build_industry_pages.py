...
FOOTER = '''<footer class="site-footer footer-rich">
  <div class="container">
    ...
    <div class="footer-bottom">
      ...
      <p class="meta" style="margin: 0;">CAN-SPAM &amp; UK GDPR compliant &nbsp;·&nbsp; Escrow via Upwork</p>
    </div>
  </div>
</footer>
<style>
...
TRADES = [
 ...
 T("Food & Hospitality","restaurants","Restaurants","restaurant website",
   ...
   [("How much detail should go on a restaurant website?","Enough to make the decision easy: menu, hours, location, a few strong photos, and a way to book. Anything more usually gets in the way on a phone."),
    ...
    ("Can I update the menu myself?","Yes. We build the menu so you can change prices and dishes in minutes, with no developer and no waiting."),
    ("Will it work for takeout and delivery too?","Absolutely — we can add direct online ordering or link your existing delivery platforms, whichever costs you less in commission.")]),
 ...
 T("Food & Hospitality","bars-pubs","Bars &amp; Pubs","bar website",
   ...
   [("Can I manage events myself?","Yes — add, edit, and remove events in minutes. The calendar and homepage update automatically."),
    ("Can people book function rooms online?","Yes. We build an enquiry-to-booking flow that captures date, headcount, and requirements so you reply with a quote, not twenty questions."),
 ...
 T("Food & Hospitality","caterers","Caterers","catering website",
   "Catering website design that turns enquiries into booked events — clear packages, fast quote requests, galleries, and SEO for &ldquo;catering near me.&rdquo;",
   "Caterers","A catering site that","books real events",
   "Catering is sold on trust and a fast, detailed quote. Your website should show the range of what you do, make the enquiry effortless, and get back the answers you need to price — date, headcount, dietary, venue — in one go.",
   "A high-converting catering website presents clear service types and sample menus, shows a strong gallery of past events, and uses a structured enquiry form that captures date, guest count, and requirements so you can quote fast and win the booking.",
   ...
   [("Services &amp; sample menus","Weddings, corporate, private — clear packages and menus that set expectations before they call."),
    ("Smart enquiry form","Captures date, headcount, dietary needs, and venue so your first reply is a quote, not a questionnaire."),
   ...
   [("What makes a catering website actually win bookings?","A clear sense of what you do, proof you do it well, and an enquiry form that gathers enough to quote quickly. Speed of reply wins more catering jobs than anything else."),
    ("Should I show prices?","Usually not fixed prices — catering is bespoke. We frame it around packages and a fast quote instead, which sets expectations without scaring anyone off."),
    ("Can the form capture dietary and venue details?","Yes — we tailor the enquiry fields to exactly what you need to price a job, so there&rsquo;s less back-and-forth."),
 ...
 T("Food & Hospitality","hotels-bnb","Hotels &amp; B&amp;Bs","hotel website",
   "Hotel and B&B website design that drives direct bookings — fast galleries, room details, a commission-free booking path, and local SEO.",
   "Hotels &amp; B&amp;Bs","A hotel site that","wins direct bookings",
   "Every booking through an OTA costs you 15&ndash;20% in commission. A fast, trustworthy website that lets guests book direct is the highest-return marketing a small hotel or B&amp;B can own.",
   "A strong hotel or B&amp;B website loads beautiful, fast room galleries, shows availability and rates clearly, and offers a direct booking path that saves the OTA commission — backed by local SEO and reviews that build trust before the guest commits.",
   ...
   [("Room galleries that sell","Fast, full-screen photography of rooms and common areas — the deciding factor for most bookings."),
    ("Direct, commission-free booking","A clean booking path (or your booking engine, embedded) so guests book with you, not an OTA."),
 ...
 T("Health & Medical","physiotherapy","Physiotherapy &amp; Chiropractic","physiotherapy website",
   ...
   "An effective physiotherapy or chiropractic website ranks for condition and injury searches, shows real reviews and clear pricing-free service info, and offers online booking so patients can grab a slot the instant they decide to seek help.",
 ...
 T("Beauty & Wellness","hair-salons","Hair Salons","hair salon website",
   ...
   "A great hair salon website offers instant online booking, shows your stylists and their work, makes prices and services clear, and ranks locally so new clients find you and existing ones rebook without a phone call.",
 ...
 T("Beauty & Wellness","barbershops","Barbershops","barbershop website",
   ...
   "Barbers lose new clients to two things: no online booking and no proof of the cuts they do. Both are easy fixes, and both are costing chairs right now.",
   ...
   [("Do barbershops really need a website?","Yes — even a simple site with booking, hours, and a cuts gallery captures the &ldquo;barber near me&rdquo; searches that otherwise go to a competitor."),
    ...
    ("Can I show prices?","If you want — simple, clear pricing works well for barbers and reduces awkward questions at the chair.")]),
 T("Beauty & Wellness","spas","Spas &amp; Beauty","spa website",
   ...
   [("Can I sell gift vouchers online?","Yes — and you should. Online vouchers are one of the biggest easy wins for spas, especially around holidays, with almost no extra work for you."),
    ...
    ("Should the site show prices?","Treatment pricing usually helps here — clients want to know before booking a spa day — but we present it tastefully, never as the headline."),
 ...
 T("Fitness","personal-trainers","Personal Trainers","personal trainer website",
   ...
   [("Transformations &amp; reviews","Real before-and-afters and client reviews — the proof that converts enquiries."),
    ("Approach &amp; packages","Clear explanation of how you work and what&rsquo;s on offer, without scaring people off on price."),
   ...
   [("What converts visitors into PT clients?","Proof and an easy next step — real transformations, honest reviews, and a simple way to book a consult the moment someone is ready to commit."),
    ("Should I show prices?","Usually not as the headline — PT is sold on outcome and fit. We frame packages and a free consult instead, which converts better."),
 ...
 T("Home & Trades","trades","Trades &amp; Contractors","tradesman website",
   "Tradesman and contractor website design — fast quote requests, project galleries, trust signals, and local SEO that brings in leads.",
   "Trades &amp; Contractors","A trades site that","brings in leads",
   "Homeowners hire the trade they trust and can reach fast. Your website should prove your work, show your service area, and make requesting a quote a thirty-second job — because the first to reply usually wins.",
   "A great tradesman website shows real project photos, makes quote requests effortless, signals trust with reviews and accreditations, and ranks for &ldquo;[trade] near me&rdquo; so local homeowners find and contact you first.",
   "Trades lose work to slow, hard-to-find websites. If a homeowner can&rsquo;t see your work, your area, and a quick way to get a quote, they call the next number on Google.",
   [("Fast quote requests","A simple request-a-quote form with photo upload, so jobs land with enough detail to price."),
   ...
   "Homeowners search &ldquo;[trade] near me&rdquo; and specific jobs, then contact the first few that look trustworthy. We build your proof, service area, and quote path so you&rsquo;re the one they call.",
   [("What gets a trades website more leads?","Showing real work, clear service areas, and a fast way to request a quote — plus ranking locally so you appear the moment someone searches your trade."),
    ...
    ("Can homeowners send photos with an enquiry?","Yes — photo upload on the quote form means you can price jobs faster and with fewer site visits."),
 ...
 T("Home & Trades","plumbers","Plumbers","plumber website",
   "Plumber website design — emergency call-outs, fast quotes, service-area pages, and local SEO that wins &ldquo;plumber near me.&rdquo;",
   ...
   "A strong plumber website makes your phone number and service area unmissable, ranks for emergency and routine searches, shows reviews and accreditations, and lets homeowners call or request a quote in one tap.",
   ...
   [("Click-to-call &amp; emergency","A prominent click-to-call and clear emergency info for the burst-pipe moment that drives the most calls."),
    ...
    ("Fast quotes","A quick quote form with photo upload for non-urgent jobs like bathrooms and boilers.")],
   ...
   [("How do plumbers get more calls from their website?","By ranking for local emergency and routine searches, loading fast, and making the phone number one tap away — so the panicking homeowner calls you first."),
    ...
    ("Can people request quotes for bigger jobs?","Yes — a quote form with photo upload lets you price bathrooms and boiler swaps without an immediate visit.")]),
 T("Home & Trades","electricians","Electricians","electrician website",
   ...
   "A good electrician website highlights your certifications and reviews, ranks for emergency and project searches, covers your service area, and makes calling or requesting a quote effortless for both urgent faults and planned work.",
   ...
   [("Certifications front and centre","NICEIC/Part P, insurance, and guarantees displayed where nervous homeowners look first."),
    ...
    ("Reviews &amp; quotes","Real reviews plus a fast quote form for larger jobs.")],
   ...
   [("What reassures homeowners hiring an electrician online?","Visible certifications, insurance, guarantees, and real reviews — proof you&rsquo;re qualified and safe. We put those exactly where cautious customers look."),
    ...
    ("Can people book or just call?","Both — we make urgent jobs one-tap callable and add a quote form for planned work.")]),
 T("Home & Trades","hvac","HVAC &amp; Heating","HVAC website",
   ...
   [("Emergency &amp; seasonal","Capture urgent no-heat / no-cool searches with click-to-call and clear availability."),
    ("Installs &amp; quotes","Showcase install work (heat pumps, AC, boilers) with a quote path for high-value jobs."),
   ...
   "People search &ldquo;AC repair near me,&rdquo; &ldquo;boiler installation [town],&rdquo; and &ldquo;heat pump quote&rdquo; depending on season and need. We build for all of it so your calendar stays full year-round.",
 ...
 T("Home & Trades","builders","Builders &amp; Contractors","builder website",
   ...
   [("Project portfolio","Rich galleries of extensions, renovations, and new-builds that prove your standard."),
    ("Trust &amp; accreditations","Memberships, insurance, guarantees, and reviews that reassure on big-budget decisions."),
   ...
   [("What wins higher-value building work online?","A portfolio that proves your standard on projects like theirs, plus trust signals and an enquiry path that qualifies serious clients. We build both."),
    ...
    ("Can the form qualify leads?","Yes — we capture project type, scope, and budget range so you spend time on the enquiries worth quoting.")]),
 T("Home & Trades","roofers","Roofers","roofing website",
   ...
   "A good roofing website ranks for emergency leak and roof-replacement searches, shows real project photos and reviews, covers your service area, and makes requesting a quote or call effortless.",
   ...
   [("Emergency &amp; repairs","Capture urgent leak searches with click-to-call and clear, reassuring availability."),
    ...
    ("Reviews &amp; quotes","Reviews, guarantees, and a fast quote form with photo upload.")],
   "Homeowners search &ldquo;roof repair near me,&rdquo; &ldquo;roofer [town],&rdquo; and &ldquo;flat roof replacement&rdquo; — often urgently. We make you rank and make getting a quote or call effortless.",
   [("How do roofers get more enquiries?","By ranking for local emergency and replacement searches and proving quality with real project photos and reviews — then making contact one tap away."),
    ...
    ("Can customers send photos of the damage?","Yes — photo upload on the quote form helps you assess and price without an immediate visit.")]),
 T("Home & Trades","landscaping","Landscaping &amp; Lawn Care","landscaping website",
   "Landscaping and lawn-care website design — project galleries, seasonal services, quote requests, and local SEO that fills your schedule.",
   "Landscaping &amp; Lawn Care","A landscaping site that","fills the schedule",
   "Landscaping sells transformation, and nothing proves it like before-and-after photos. Your website should make people picture their own garden transformed, then make booking a quote effortless.",
   "A strong landscaping website leads with before-and-after galleries, lays out seasonal and one-off services, makes quote requests easy, and ranks for &ldquo;landscaper near me&rdquo; and &ldquo;garden design [town].&rdquo;",
   ...
   [("Before-and-after galleries","Transformation photos that sell the outcome better than any words."),
    ...
    ("Easy quote requests","A quick form with photo upload so you can scope and price jobs fast."),
    ("Local SEO","Win &ldquo;landscaper near me,&rdquo; &ldquo;garden design [town],&rdquo; and &ldquo;lawn care [town].&rdquo;")],
   "People search &ldquo;landscaper near me,&rdquo; &ldquo;garden design [town],&rdquo; and specific jobs like paving or turfing. We build galleries and service pages that turn those searches into booked quotes.",
   [("What sells landscaping work online?","Before-and-after photos — they let people picture their own garden transformed, which is what drives the enquiry. We make them the centrepiece."),
    ...
    ("Can people get a quote without a visit?","Often yes — a photo-upload quote form lets you scope many jobs remotely first."),
 ...
 T("Home & Trades","painters","Painters &amp; Decorators","painter decorator website",
   "Painter and decorator website design — portfolios, clear services, easy quotes, and local SEO that keeps the diary booked.",
   "Painters &amp; Decorators","A decorating site that","keeps you booked",
   "Decorating is judged on finish and reliability. Your website should show clean, crisp work, make requesting a quote simple, and prove you turn up and do it properly — the two things customers actually worry about.",
   "A good painter and decorator website shows a portfolio of clean finishes, lists interior and exterior services clearly, makes quotes easy, and ranks for &ldquo;painter and decorator near me.&rdquo;",
   "Decorators lose jobs when their site shows no real work and makes getting a quote a hassle. Customers want to see the finish and reach you fast — most sites deliver neither.",
   [("Finish portfolio","Photos of crisp interior and exterior work that prove your standard."),
    ...
    ("Easy quotes","A simple quote form with photo upload for fast, accurate pricing."),
    ("Local SEO","Win &ldquo;painter and decorator near me&rdquo; and &ldquo;[town] decorator.&rdquo;")],
   "Customers search &ldquo;painter and decorator near me&rdquo; and specific jobs. We prove your finish and make getting a quote effortless so the booking is yours.",
   [("What gets decorators more work online?","Proof of clean finishes and an easy quote path, plus ranking locally so customers find you first. We build all three."),
    ...
    ("Can customers send photos for a quote?","Yes — photo upload lets you price many jobs before visiting.")]),
 T("Home & Trades","cleaning","Cleaning Services","cleaning company website",
   "Cleaning company website design — instant quotes and booking, service types, trust signals, and local SEO that books recurring clients.",
   "Cleaning Services","A cleaning site that","books recurring clients",
   "Cleaning is recurring revenue, and the easier you make booking, the faster that revenue compounds. Your website should let people get a price and book a regular clean in minutes, not wait for a callback.",
   "A strong cleaning website offers instant quotes and online booking, clearly separates domestic, commercial, and specialist services, builds trust with reviews and insurance, and ranks for &ldquo;cleaners near me.&rdquo;",
   ...
   [("Instant quote &amp; booking","Let customers get a price and book a one-off or recurring clean online, right away."),
   ...
   "People search &ldquo;cleaners near me,&rdquo; &ldquo;end of tenancy cleaning [town],&rdquo; and &ldquo;office cleaning&rdquo; and want a fast price. We make quoting and booking instant so they book you, not the slower competitor.",
   [("Can customers get a price and book online?","Yes — instant online quotes and booking are the biggest win for cleaning companies, turning interest into recurring contracts immediately."),
 ...
 T("Professional Services","law-firms","Law Firms &amp; Solicitors","law firm website",
   ...
   "Clients search &ldquo;divorce solicitor [town],&rdquo; &ldquo;conveyancing quote,&rdquo; and &ldquo;employment lawyer near me.&rdquo; We build authoritative practice-area pages that rank and convert those anxious searches into enquiries.",
 ...
 T("Professional Services","consultants","Consultants &amp; Coaches","consultant website",
   ...
   "Most consultant sites are vague — full of buzzwords, light on who they help and what changes. Clarity and proof are what convert high-value clients; vagueness just attracts price-shoppers.",
   ...
   [("What converts visitors into consulting clients?","Clarity and authority — being unmistakably clear about who you help and the outcome you deliver, backed by proof, with an easy way to book a call."),
    ("Should I show prices?","Usually not — high-value consulting is sold on outcome and fit via a call. We frame the offer and a discovery call instead, which converts far better."),
 ...
 T("Events & Creative","photographers","Photographers","photographer website",
   ...
   [("How fast does my photography site need to be?","Very — heavy galleries that load slowly lose clients before the images even appear. We optimise so your work loads fast and looks flawless."),
    ...
    ("Should I show prices?","A starting point or packages usually helps filter enquiries — we present it tastefully so it qualifies without scaring people off."),
 ...
 T("Events & Creative","wedding-planners","Wedding &amp; Event Planners","wedding planner website",
   ...
   [("What matters most on a planner&rsquo;s website?","Taste and trust — a beautiful, on-brand portfolio that proves your style, with an easy, warm enquiry path. It&rsquo;s an emotional decision, and the site has to feel right."),
    ...
    ("Do I need to show prices?","Usually a starting point helps qualify enquiries; full pricing is bespoke. We frame it so the right couples feel comfortable reaching out."),
 ...
 T("Education & Care","childcare","Childcare &amp; Nurseries","nursery website",
   ...
   "Nursery sites that feel cold or hide the basics — fees-free key info, ratios, the setting, how to visit — lose anxious parents to settings that feel open and reassuring.",
...
<section class="section" style="border-top: 1px solid var(--line); background: var(--bg-soft);">
  <div class="container">
    <div data-reveal style="max-width: 720px; margin: 0 auto; text-align: center;">
      ...
      <p class="lead" style="margin-top: 1.5rem;">You work directly with the brothers who write the code &mdash; Adnan in Multan, Irfan in Dubai. Two Top Rated Upwork operators, a thousand projects since 2017, and a 100% Job Success Score. Hire us directly, or run it escrow-protected through Upwork &mdash; your call.</p>
...
<section class="paper" style="padding: 5.5rem 0 3.5rem;">
  <div class="container">
    ...
    <div data-reveal style="max-width: 920px;">
      ...
      <p style="margin-top: 1.5rem; font-size: 0.85rem; color: var(--muted);"><strong style="color: var(--ink);">Top Rated on Upwork</strong> · 100% Job Success · US, UK &amp; Canada hours · Direct hire or Upwork escrow</p>
    </div>
...
def render_hub():
    ...
    hub_faqs = [
        ...
        ("Do I work with an agency or directly with the developer?",
         "Directly with the brothers who write the code — Adnan and Irfan, both Top Rated on Upwork. No account managers, no junior handoffs. You can hire us directly or run the project escrow-protected through Upwork."),
    ]
    jsonld = [
...
<section class="paper" style="padding: 5.5rem 0 3.5rem;">
  <div class="container">
    ...
    <div data-reveal style="max-width: 920px;">
      ...
      <p style="margin-top: 1.5rem; font-size: 0.85rem; color: var(--muted);"><strong style="color: var(--ink);">Top Rated on Upwork</strong> · 100% Job Success · 1,000+ projects · Direct hire or Upwork escrow</p>
    </div>
    <div class="answer-box" data-reveal style="max-width: 820px;">
...
def update_llms():
    p = ROOT / "llms.txt"
    txt = p.read_text()
    # Remove any pricing line (no pricing anywhere on the site)
    txt = re.sub(r"- Typical [^\n]*\n", "- Pricing is shared on a short strategy call; every project is fixed-scope, fixed-date, and includes 30 days of post-launch support.\n", txt)
